...
@Component({
  selector: 'app-simple-input-field',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './simple-input-field.component.html',
  styleUrl: './simple-input-field.component.scss',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: SimpleInputFieldComponent,
      multi: true
    }
  ]
})
export class SimpleInputFieldComponent implements OnInit, ControlValueAccessor {

  // INPUTS
  @Input() required: boolean = false;
  @Input() id: string = 'simple-input-field';
